...
1. Descarga e instala esta app en tu móvil Android:  
   📲 https://play.google.com/store/apps/details?id=com.pas.webcam&hl=es&pli=1  
2. Abre la app y pulsa **“Start server”** (al final del menú).  
3. Luego, abre este programa y escribe la dirección IP que aparece en la app del teléfono.  
4. Se cargarán dos módulos (acepta cuando se te pida).  
5. Finalmente, se mostrará el mensaje de **cámara conectada**. En tu móvil verás también **“video connections: 1”**.
...
1. Download and install this Android app:  
   📲 https://play.google.com/store/apps/details?id=com.pas.webcam&hl=es&pli=1  
2. Open the app and tap **“Start server”** (at the bottom).  
3. Then, open this program and enter your phone’s IP address.  
4. It will load two modules (click accept when prompted).  
5. Finally, a **camera connected** message will appear. On your phone you'll also see **“video connections: 1”**.
